...
public class Assembler
{
    ...
    {
        uint uInstr = AsmEncoder.AsmJ(opcode, rd, offset);
    ...
    {
        uint uInstr = AsmEncoder.AsmB(opcode, src1, src2, offset);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmS(opcode, src2, baseReg, offset);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmI(opcode, dst, src1, src2);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmR(opcode, dst, src1, src2);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmR4(opcode, dst, src1, src2, src3, roundingMode);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmF(opcode, dst, src1, src2, roundingMode);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmF(opcode, dst, src1, roundingMode);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
    ...
    {
        uint uInstr = AsmEncoder.AsmU(opcode, dst, src1);
        Section.WriteLeWord32(instrPtr, uInstr);
        instrPtr += 4;
    }
