...
public class AssemblerTests
{
    ...
    public void RiscvAsm_beq()
    {
        ...
        m => m.asm(Mnemonics.beq, op2, op3, -1366));
    }
    ...
    public void RiscvAsm_blt()
    {
        ...
        m => m.asm(Mnemonics.blt, op2, op3, -1366));
    }
    ...
    public void RiscvAsm_bge()
    {
        ...
        m => m.asm(Mnemonics.bge, op2, op3, -1366));
    }
    ...
    public void RiscvAsm_bltu()
    {
        ...
        m => m.asm(Mnemonics.bltu, op2, op3, -1366));
    }
    ...
    public void RiscvAsm_bgeu()
    {
        ...
        m => m.asm(Mnemonics.bgeu, op2, op3, -1366));
    }
    ...
    public void RiscvAsm_sltiu()
    {
        ...
        m => m.asm(Mnemonics.sltiu, op1, op2, -2));
    }
    ...
    public void RiscvAsm_xori()
    {
        ...
        m => m.asm(Mnemonics.xori, op1, op2, -2));
    }
    ...
    public void RiscvAsm_ori()
    {
        ...
        m => m.asm(Mnemonics.ori, op1, op2, -2));
    }
    ...
    public void RiscvAsm_andi()
    {
        RunTest(
            ...
            m => m.asm(Mnemonics.andi, op1, op2, -2));
    }
    ...
    public void RiscvAsm_srli()
    {
        RunTest(
            ...
            m => m.asm(Mnemonics.srli, op1, op2, op3));
    }
    ...
    public void RiscvAsm_srai()
    {
        ...
        m => m.asm(Mnemonics.srai, op1, op2, op3));
    }
    ...
    public void RiscvAsm_add()
    {
        ...
        m => m.asm(Mnemonics.add, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sub()
    {
        ...
        m => m.asm(Mnemonics.sub, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sll()
    {
        ...
        m => m.asm(Mnemonics.sll, op1, op2, op3));
    }
    ...
    public void RiscvAsm_slt()
    {
        ...
        m => m.asm(Mnemonics.slt, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sltu()
    {
        ...
        m => m.asm(Mnemonics.sltu, op1, op2, op3));
    }
    ...
    public void RiscvAsm_xor()
    {
        ...
        m => m.asm(Mnemonics.xor, op1, op2, op3));
    }
    ...
    public void RiscvAsm_srl()
    {
        ...
        m => m.asm(Mnemonics.srl, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sra()
    {
        ...
        m => m.asm(Mnemonics.sra, op1, op2, op3));
    }
    ...
    public void RiscvAsm_or()
    {
        ...
        m => m.asm(Mnemonics.or, op1, op2, op3));
    }
    ...
    public void RiscvAsm_and()
    {
        ...
        m => m.asm(Mnemonics.and, op1, op2, op3));
    }
    ...
    public void RiscvAsm_fence_tso()
    {
        ...
        m => m.asm(Mnemonics.fence_tso, op1, op2, op3));
    }
    ...
    public void RiscvAsm_pause()
    {
        ...
        m => m.asm(Mnemonics.pause, op1, op2, op3));
    }
    ...
    public void RiscvAsm_ebreak()
    {
        ...
        m => m.asm(Mnemonics.ebreak, op1, op2, op3));
    }
    ...
    public void RiscvAsm_lwu()
    {
        ...
        m => m.asm(Mnemonics.lwu, op1, op2, -2));
    }
    ...
    public void RiscvAsm_ld()
    {
        ...
        m => m.asm(Mnemonics.ld, op1, op2, -2));
    }
    ...
    public void RiscvAsm_sd()
    {
        ...
        m => m.asm(Mnemonics.sd, op3, op2, -1366));
    }
    ...
    public void RiscvAsm_slli()
    {
        ...
        m => m.asm(Mnemonics.slli, op1, op2, op3));
    }
    ...
    public void RiscvAsm_srli_64()
    {
        ...
        m => m.asm(Mnemonics.srli, op1, op2, 0b110101));
    }
    ...
    public void RiscvAsm_srai_64()
    {
        ...
        m => m.asm(Mnemonics.srai, op1, op2, 0b110101));
    }
    ...
    public void RiscvAsm_addiw()
    {
        ...
        m => m.asm(Mnemonics.addiw, op1, op2, -2));
    }
    ...
    public void RiscvAsm_slliw()
    {
        ...
        m => m.asm(Mnemonics.slliw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_srliw()
    {
        ...
        m => m.asm(Mnemonics.srliw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sraiw()
    {
        ...
        m => m.asm(Mnemonics.sraiw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_addw()
    {
        ...
        m => m.asm(Mnemonics.addw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_subw()
    {
        ...
        m => m.asm(Mnemonics.subw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sllw()
    {
        ...
        m => m.asm(Mnemonics.sllw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_srlw()
    {
        ...
        m => m.asm(Mnemonics.srlw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sraw()
    {
        ...
        m => m.asm(Mnemonics.sraw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_fence_i()
    {
        ...
        m => m.asm(Mnemonics.fence_i, op1, op2, op3));
    }
    ...
    public void RiscvAsm_csrrw()
    {
        ...
        m => m.asm(Mnemonics.csrrw, op1, op2, 0xF0F));
    }
    ...
    public void RiscvAsm_csrrs()
    {
        ...
        m => m.asm(Mnemonics.csrrs, op1, op2, 0xF0F));
    }
    ...
    public void RiscvAsm_csrrc()
    {
        ...
        m => m.asm(Mnemonics.csrrc, op1, op2, 0xF0F));
    }
    ...
    public void RiscvAsm_csrrwi()
    {
        ...
        m => m.asm(Mnemonics.csrrwi, op1, op2, 0xF0F));
    }
    ...
    public void RiscvAsm_csrrsi()
    {
        ...
        m => m.asm(Mnemonics.csrrsi, op1, op2, 0xF0F));
    }
    ...
    public void RiscvAsm_csrrci()
    {
        ...
        m => m.asm(Mnemonics.csrrci, op1, op2, 0xF0F));
    }
    ...
    public void RiscvAsm_mulh()
    {
        ...
        m => m.asm(Mnemonics.mulh, op1, op2, op3));
    }
    ...
    public void RiscvAsm_mulhsu()
    {
        ...
        m => m.asm(Mnemonics.mulhsu, op1, op2, op3));
    }
    ...
    public void RiscvAsm_mulhu()
    {
        ...
        m => m.asm(Mnemonics.mulhu, op1, op2, op3));
    }
    ...
    public void RiscvAsm_div()
    {
        ...
        m => m.asm(Mnemonics.div, op1, op2, op3));
    }
    ...
    public void RiscvAsm_divu()
    {
        ...
        m => m.asm(Mnemonics.divu, op1, op2, op3));
    }
    ...
    public void RiscvAsm_rem()
    {
        ...
        m => m.asm(Mnemonics.rem, op1, op2, op3));
    }
    ...
    public void RiscvAsm_remu()
    {
        ...
        m => m.asm(Mnemonics.remu, op1, op2, op3));
    }
    ...
    public void RiscvAsm_mulw()
    {
        ...
        m => m.asm(Mnemonics.mulw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_divw()
    {
        ...
        m => m.asm(Mnemonics.divw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_divuw()
    {
        ...
        m => m.asm(Mnemonics.divuw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_remw()
    {
        ...
        m => m.asm(Mnemonics.remw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_remuw()
    {
        ...
        m => m.asm(Mnemonics.remuw, op1, op2, op3));
    }
    ...
    public void RiscvAsm_lr_w()
    {
        ...
        m => m.asm(Mnemonics.lr_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_sc_w()
    {
        ...
        m => m.asm(Mnemonics.sc_w, op1, op2, op3));
    }
...
/*
    ...
    public void RiscvAsm_amoswap_w()
    {
        ...
        m => m.asm(Mnemonics.amoswap_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amoadd_w()
    {
        ...
        m => m.asm(Mnemonics.amoadd_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amoxor_w()
    {
        ...
        m => m.asm(Mnemonics.amoxor_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amoand_w()
    {
        ...
        m => m.asm(Mnemonics.amoand_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amoor_w()
    {
        ...
        m => m.asm(Mnemonics.amoor_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amomin_w()
    {
        ...
        m => m.asm(Mnemonics.amomin_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amomax_w()
    {
        ...
        m => m.asm(Mnemonics.amomax_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amominu_w()
    {
        ...
        m => m.asm(Mnemonics.amominu_w, op1, op2, op3));
    }
    ...
    public void RiscvAsm_amomaxu_w()
    {
        ...
        m => m.asm(Mnemonics.amomaxu_w, op1, op2, op3));
    }
...
public void RiscvAsm_lr_d()
{
    ...
    m => m.asm(Mnemonics.lr_d, op1, op2, op3));
}
...
public void RiscvAsm_sc_d()
{
    ...
    m => m.asm(Mnemonics.sc_d, op1, op2, op3));
}
...
public void RiscvAsm_amoswap_d()
{
    ...
    m => m.asm(Mnemonics.amoswap_d, op1, op2, op3));
}
...
public void RiscvAsm_amoadd_d()
{
    ...
    m => m.asm(Mnemonics.amoadd_d, op1, op2, op3));
}
...
public void RiscvAsm_amoxor_d()
{
    ...
    m => m.asm(Mnemonics.amoxor_d, op1, op2, op3));
}
...
public void RiscvAsm_amoand_d()
{
    ...
    m => m.asm(Mnemonics.amoand_d, op1, op2, op3));
}
...
public void RiscvAsm_amoor_d()
{
    ...
    m => m.asm(Mnemonics.amoor_d, op1, op2, op3));
}
...
public void RiscvAsm_amomin_d()
{
    ...
    m => m.asm(Mnemonics.amomin_d, op1, op2, op3));
}
...
public void RiscvAsm_amomax_d()
{
    ...
    m => m.asm(Mnemonics.amomax_d, op1, op2, op3));
}
...
public void RiscvAsm_amominu_d()
{
    ...
    m => m.asm(Mnemonics.amominu_d, op1, op2, op3));
}
...
public void RiscvAsm_amomaxu_d()
{
    ...
    m => m.asm(Mnemonics.amomaxu_d, op1, op2, op3));
}
*/
...
public void RiscvAsm_fsgnj_s()
{
    ...
    m => m.asm(Mnemonics.fsgnj_s, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjn_s()
{
    ...
    m => m.asm(Mnemonics.fsgnjn_s, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjx_s()
{
    ...
    m => m.asm(Mnemonics.fsgnjx_s, op1, op2, op3));
}
...
public void RiscvAsm_fmin_s()
{
    ...
    m => m.asm(Mnemonics.fmin_s, op1, op2, op3));
}
...
public void RiscvAsm_fmax_s()
{
    ...
    m => m.asm(Mnemonics.fmax_s, op1, op2, op3));
}
...
public void RiscvAsm_fmv_x_w()
{
    ...
    m => m.asm(Mnemonics.fmv_x_w, op1, op2, op3));
}
...
public void RiscvAsm_feq_s()
{
    ...
    m => m.asm(Mnemonics.feq_s, op1, op2, op3));
}
...
public void RiscvAsm_flt_s()
{
    ...
    m => m.asm(Mnemonics.flt_s, op1, op2, op3));
}
...
public void RiscvAsm_fle_s()
{
    ...
    m => m.asm(Mnemonics.fle_s, op1, op2, op3));
}
...
public void RiscvAsm_fclass_s()
{
    ...
    m => m.asm(Mnemonics.fclass_s, op1, op2, op3));
}
...
public void RiscvAsm_fmv_w_x()
{
    ...
    m => m.asm(Mnemonics.fmv_w_x, op1, op2, op3));
}
...
public void RiscvAsm_fsgnj_d()
{
    ...
    m => m.asm(Mnemonics.fsgnj_d, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjn_d()
{
    ...
    m => m.asm(Mnemonics.fsgnjn_d, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjx_d()
{
    ...
    m => m.asm(Mnemonics.fsgnjx_d, op1, op2, op3));
}
...
public void RiscvAsm_fmin_d()
{
    ...
    m => m.asm(Mnemonics.fmin_d, op1, op2, op3));
}
...
public void RiscvAsm_fmax_d()
{
    ...
    m => m.asm(Mnemonics.fmax_d, op1, op2, op3));
}
...
public void RiscvAsm_feq_d()
{
    ...
    m => m.asm(Mnemonics.feq_d, op1, op2, op3));
}
...
public void RiscvAsm_flt_d()
{
    ...
    m => m.asm(Mnemonics.flt_d, op1, op2, op3));
}
...
public void RiscvAsm_fle_d()
{
    ...
    m => m.asm(Mnemonics.fle_d, op1, op2, op3));
}
...
public void RiscvAsm_fclass_d()
{
    ...
    m => m.asm(Mnemonics.fclass_d, op1, op2, op3));
}
...
public void RiscvAsm_fmv_x_d()
{
    ...
    m => m.asm(Mnemonics.fmv_x_d, op1, op2, op3));
}
...
public void RiscvAsm_fmv_d_x()
{
    ...
    m => m.asm(Mnemonics.fmv_d_x, op1, op2, op3));
}
...
public void RiscvAsm_fsgnj_q()
{
    ...
    m => m.asm(Mnemonics.fsgnj_q, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjn_q()
{
    ...
    m => m.asm(Mnemonics.fsgnjn_q, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjx_q()
{
    ...
    m => m.asm(Mnemonics.fsgnjx_q, op1, op2, op3));
}
...
public void RiscvAsm_fmin_q()
{
    ...
    m => m.asm(Mnemonics.fmin_q, op1, op2, op3));
}
...
public void RiscvAsm_fmax_q()
{
    ...
    m => m.asm(Mnemonics.fmax_q, op1, op2, op3));
}
...
public void RiscvAsm_feq_q()
{
    ...
    m => m.asm(Mnemonics.feq_q, op1, op2, op3));
}
...
public void RiscvAsm_flt_q()
{
    ...
    m => m.asm(Mnemonics.flt_q, op1, op2, op3));
}
...
public void RiscvAsm_fle_q()
{
    ...
    m => m.asm(Mnemonics.fle_q, op1, op2, op3));
}
...
public void RiscvAsm_fclass_q()
{
    ...
    m => m.asm(Mnemonics.fclass_q, op1, op2, op3));
}
...
public void RiscvAsm_fsgnj_h()
{
    ...
    m => m.asm(Mnemonics.fsgnj_h, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjn_h()
{
    ...
    m => m.asm(Mnemonics.fsgnjn_h, op1, op2, op3));
}
...
public void RiscvAsm_fsgnjx_h()
{
    ...
    m => m.asm(Mnemonics.fsgnjx_h, op1, op2, op3));
}
...
public void RiscvAsm_fmin_h()
{
    ...
    m => m.asm(Mnemonics.fmin_h, op1, op2, op3));
}
...
public void RiscvAsm_fmax_h()
{
    ...
    m => m.asm(Mnemonics.fmax_h, op1, op2, op3));
}
...
public void RiscvAsm_feq_h()
{
    ...
    m => m.asm(Mnemonics.feq_h, op1, op2, op3));
}
...
public void RiscvAsm_flt_h()
{
    ...
    m => m.asm(Mnemonics.flt_h, op1, op2, op3));
}
...
public void RiscvAsm_fle_h()
{
    ...
    m => m.asm(Mnemonics.fle_h, op1, op2, op3));
}
...
public void RiscvAsm_fclass_h()
{
    ...
    m => m.asm(Mnemonics.fclass_h, op1, op2, op3));
}
...
public void RiscvAsm_fmv_x_h()
{
    ...
    m => m.asm(Mnemonics.fmv_x_h, op1, op2, op3));
}
...
public void RiscvAsm_fmv_h_x()
{
    ...
    m => m.asm(Mnemonics.fmv_h_x, op1, op2, op3));
}
...
public void RiscvAsm_wrs_nto()
{
    ...
    m => m.asm(Mnemonics.wrs_nto, op1, op2, op3));
}
...
public void RiscvAsm_wrs_sto()
{
    ...
    m => m.asm(Mnemonics.wrs_sto, op1, op2, op3));
}
